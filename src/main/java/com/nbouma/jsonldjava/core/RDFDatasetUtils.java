...
import static com.nbouma.jsonldjava.core.Regex.HEX;
...
public class RDFDatasetUtils {
    ...
    static void toNQuad(RDFDataset.Quad triple, String graphName, String bnode,
        ...
        if (o.get("type").equals("IRI")) {
            output.append("<");
            escape(o.getValue(), output);
            output.append(">");
        } else if (o.get("type").equals("blank node")) {
            // normalization mode
            if (bnode != null) {
            ...
            output.append("\"");
            String escape = o.getValue().replaceAll("\\\"", "\"")
                    .replaceAll("\t", "\\t")
                    .replaceAll("\n", "\\n")
                    .replaceAll("\r", "\\r")
                    .replaceAll("\"", "\\\"");
